...
backtest (a separate subsystem — see backtest). No fourth
...
Usage:
    ...
    python3 -m cli.run_strategy --strategies ten_percent_otm_strangle

Cron example (runs at 09:20 IST = 03:50 UTC, Mon–Fri):
    50 3 * * 1-5 cd /var/www/html/automate && python3 -m cli.run_strategy >> logs/cron.log 2>&1
...
from utils.position_tracker import has_open_position, record_open_position
