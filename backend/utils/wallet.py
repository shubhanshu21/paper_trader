...
from db.models import WalletSettings
from utils.margin import (
    INDEX_SYMBOLS,
    estimate_margin_blocked,
    is_commodity_instrument_key,
)
from utils.pnl import compute_strangle_pnl, entry_charges_only
from utils.position_tracker import get_closed_positions, get_open_positions
from utils.wallet_adjustments import load_adjustments, total_adjustments
...
def set_starting_capital(user_id: int, value: float) -> float:
    ...
    from utils.position_tracker import delete_closed_positions
