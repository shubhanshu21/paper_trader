...
from api.custom_strategy_scheduler import _reconcile_live_positions
...
class TestReconcileLivePositions:
    ...
    def test_matching_positions_send_no_alert(self, db, monkeypatch):
        ...
        db.commit()
        notified = []
        monkeypatch.setattr("api.custom_strategy_scheduler.notify", lambda *a, **k: notified.append((a, k)))
