...
import api.iv_history_scheduler as scheduler
...
class TestSnapshotSymbolIv:
    def test_returns_none_when_chain_lookup_fails(self):
        ...
        with patch("strategies.custom.rule_strategy.resolve_leg_strike", return_value=20000):
    ...
    def test_returns_none_on_missing_forward_price(self):
        ...
        with patch("utils.instrument_cache.InstrumentCache.resolve_nearest_future_key", return_value=None):
            assert scheduler._snapshot_symbol_iv(broker, "NIFTY") is None
