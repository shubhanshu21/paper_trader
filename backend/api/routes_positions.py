...
from api.deps import compute_mtm_economics, get_audit_trail, get_brokers, get_rate_limiter
from utils.pnl import compute_strangle_pnl
from utils.position_tracker import get_closed_positions, get_open_positions, get_position
...
def close_position_now(position_id: int, user: dict = Depends(get_current_user)):
    from cli.run_position_monitor import close_position_manual
